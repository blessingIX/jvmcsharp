...
namespace jvmcsharp.instructions
{
    internal class InstructionFactory
    {
        ...
        // public static readonly RETURN _return = new();
        ...
        public static Instruction Create(byte opcode)
        {
            return opcode switch
            {
                ...
                // case 0xb0 => areturn,
                // case 0xb1 => _return,
                // case 0xb2 => new GET_STATIC(),
                // case 0xb3 => new PUT_STATIC(),
                // case 0xb4 => new GET_FIELD(),
                // case 0xb5 => new PUT_FIELD(),
                // case 0xb6 => new INVOKE_VIRTUAL(),
                // case 0xb7 => new INVOKE_SPECIAL(),
                // case 0xb8 => new INVOKE_STATIC(),
                // case 0xb9 => new INVOKE_INTERFACE(),
                // case 0xba => new INVOKE_DYNAMIC(),
                // case 0xbb => new NEW(),
                // case 0xbc => new NEW_ARRAY(),
                // case 0xbd => new ANEW_ARRAY(),
                // case 0xbe => arraylength,
                // case 0xbf => athrow,
                // case 0xc0 => new CHECK_CAST(),
                // case 0xc1 => new INSTANCE_OF(),
